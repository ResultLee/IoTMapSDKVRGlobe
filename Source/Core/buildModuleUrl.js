...
/*global Space_BASEURL,define,require*/
...
function getCesiumBaseUrl() {
  ...
  let baseUrlString;
  if (typeof Space_BASEURL !== "undefined") {
    baseUrlString = Space_BASEURL;
  } else if (
  ...
  if (!defined(baseUrlString)) {
    throw new DeveloperError(
      "Unable to determine Cesium base URL automatically, try defining a global variable called Space_BASEURL."
    );
  }
  //>>includeEnd('debug');
