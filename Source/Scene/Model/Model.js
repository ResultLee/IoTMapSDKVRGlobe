 ...
 * @internalConstructor
 *
 * @Param {ResourceLoader} options.loader The loader used to load resources for this model.
 * @Param {ModelType} options.type Type of this model, to distinguish individual glTF files from 3D Tiles internally. 
