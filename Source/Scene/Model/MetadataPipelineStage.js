...
MetadataPipelineStage.process = function(
  ...
  const statistics = content ? content.tileset.metadataExtension ? content.tileset.metadataExtension.statistics : undefined : undefined;
...
function getPropertyAttributeInfo(propertyAttribute, primitive, statistics) {
  ...
  const classStatistics = statistics ? statistics.classes[classId] : undefined;
  ...
  for (let i = 0; i < propertiesArray.length; i++) {
    ...
    infoArray[i] = {
      ...
      glslType,
      variableName,
      propertyStatistics: classStatistics ? classStatistics.properties[propertyId] : undefined,
