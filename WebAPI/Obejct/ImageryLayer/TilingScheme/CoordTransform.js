 ...
 * 坐标位置转换工具
 * @private
 * @description WGS-84坐标系,84坐标系
 * @description GCJ-02坐标系,google中国地图、soso地图、aliyun地图、mapabc地图和高德地图所用的经纬度坐标
 * @description BD-09坐标系,百度地图采用的经纬度坐标
 * @description 详细信息请参考github {@link https://github.com/hujiulong/gcoord}
 */
