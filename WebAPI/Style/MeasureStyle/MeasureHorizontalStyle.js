...
class MeasureHorizontalStyle {
    constructor(options) {
        options = defaultValue(options, defaultValue.EMPTY_OBJECT);

        this._type = Style.MEASUREHORIZONTALSTYLE;
    ...
    _getStyle(positions) {
        ...
        points.push(getStyleByPosition(startPoint));
        ...
        positions = [startPoint, midPoint, endPoint];
    ...
    clone() {
        return new MeasureHorizontalStyle();
    }
}

export default MeasureHorizontalStyle;
